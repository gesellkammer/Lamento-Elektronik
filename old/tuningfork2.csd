...
gi_gate_attack_factor = 3

; Q of the detect filter (bw = freq * q)
gi_qfactor = 0.05

; attack and release time of the aplitude follower
; gi_attack  = 0.05
gi_rel     = 0.01
...
opcode tuningfork, ak, iakkkkkkk
	...
	aenv  follow2 adetect1, kattack, gi_rel
	ienvcutoff = 30
	...
	aout compress2 aout, aout, igatedB, -16, -4, icompratio, 0.001, 0.01, 0.001
